...
| tests            | tests/            | 单测 + chat:e2e(6 场景) + preview:e2e(18) + electron-uat(6) + verify-full 门禁矩阵 |
...
- 会话处理的推送契约与状态机在 shared/main 边界已完整落地并有门禁（**489 unit** + 门禁矩阵：chat:e2e 6 + preview:e2e 18 + uat 6，2026-09-04）。
