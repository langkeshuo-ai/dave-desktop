...
| 版本   | 0.1.0(0.2→0.4 能力线:性能/可观测性/skills/i18n/插件市场/门禁矩阵,均已落地)                                                         |
| 门禁   | `node tests/verify-full.mjs` 全绿:build / **477 tests** / chat:e2e **4 场景** / preview:e2e **18/18**(2026-09-03) |
| 架构   | Electron 三进程(main / preload / renderer)+ `src/shared/` 纯函数共享层(IPC 边界校验全在此,node 可单测)                           |
| 提交   | 本地有 git 仓库但**无 remote**(见 HANDOFF §5)                                                                         |
